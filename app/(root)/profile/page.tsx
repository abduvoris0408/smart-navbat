...
export default function ProfilePage() {
  ...
  const [profileData, setProfileData] = useLocalStorage<ProfileData>('profileData', defaultData)
  const [profileImage, setProfileImage] = useLocalStorage<string>('profileImage', '/placeholder.svg?height=80&width=80')
